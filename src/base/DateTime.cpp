...
//   // - Year
//   if (dateGetYear(a1) < dateGetYear(a2))
//     return true;
//   else if (dateGetYear(a1) > dateGetYear(a2))
//     return false;
//   // - Month
//   else if (dateGetMonth(a1) < dateGetMonth(a2))
//     return true;
//   else if (dateGetMonth(a1) > dateGetMonth(a2))
//     return false;
//   // - Day
//   else if (dateGetDay(a1) < dateGetDay(a2))
//     return true;
//   else if (dateGetDay(a1) > dateGetDay(a2))
//     return false;
...
//   if (DateTime::timeGetHour(t1) < DateTime::timeGetHour(t2))
//     return true;
//   else if (DateTime::timeGetHour(t1) > DateTime::timeGetHour(t2))
//     return false;
//
//   else if (DateTime::timeGetMinute(t1) < DateTime::timeGetMinute(t2))
//     return true;
//   else if (DateTime::timeGetMinute(t1) > DateTime::timeGetMinute(t2))
//     return false;
//
//   else if (DateTime::timeGetSecond(t1) < DateTime::timeGetSecond(t2))
//     return true;
//   else if (DateTime::timeGetSecond(t1) > DateTime::timeGetSecond(t2))
//     return false;
//
//   else if (DateTime::timeGetMS(t1) < DateTime::timeGetMS(t2))
//     return true;
//   else if (DateTime::timeGetMS(t1) > DateTime::timeGetMS(t2))
//     return false;
//
