...
public:
  ...
  void setPixel32(int32_t x, int32_t y, const Pixel4ub& pix);
  ...
  int8_t toGray(const Pixel4ub& in);                                                                  // returns the gray value of this pixel.
  static Pixel4ub invert(const Pixel4ub&);                                                            // - Inverts a pixel
