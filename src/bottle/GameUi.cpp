...
void GameUi::constructUI(std::shared_ptr<BottleScript> r) {
  BRLogInfo("Making UI.");
  {
    _pScript = r;
...
//////////////////////////////////////////////////////////////////////////
std::shared_ptr<UiAssetItem> UiAssetItem::create(std::shared_ptr<GameUi> gi, std::shared_ptr<ModelSpec> ms, float contW, float contH,
  ...
  */
  ...
  c2->width() = "100%";
  //   c3->width() = "auto";
  std::shared_ptr<UiScreen> screen = gi->getScript()->getScene()->getUiScreen();

  std::shared_ptr<UiTex> thumbTex = UiTex::create(screen, ms->getThumb());
  ...
  // std::weak_ptr<BottleScript> weak_b = _PROC_THREAD_ATTRIBUTE_NUM
  ...
  expb->setClick([weak_a]() {
    if (std::shared_ptr<UiAssetItem> ua = weak_a.lock()) {
        ...
        //Object placement needs to be tested.
        ua->_pGameUi->getScript()->placeObject(ua->_pNode);
    }
    });
...
void GameUi::createCursor() {
  ...
  cs->width() = "32px";
  cs->height() = "auto"; // Auto?
  getScript()->getScene()->getUiScreen()->setCursor(cs);
}
void GameUi::createDummySkin() {
  ...
  ws->_pBorderImgs = Ui9Tex::create(getScript()->getScene()->getUiScreen(), Gu::getPackage()->makeAssetPath("ui", "wings-window-9p.png"));
  ws->_pCloseButton = std::make_shared<UiButtonSkin>();
  ws->_pCloseButton->_pUp = UiTex::create(screen, Gu::getPackage()->makeAssetPath("ui", "wings-win-canc-up.png"));
  ws->_pCloseButton->_pHv = UiTex::create(screen, Gu::getPackage()->makeAssetPath("ui", "wings-win-canc-hv.png"));
  ws->_pCloseButton->_pDn = UiTex::create(screen, Gu::getPackage()->makeAssetPath("ui", "wings-win-canc-dn.png"));

  ws->_pHScroll = std::make_shared<UiScrollbarSkin>();
  ws->_pHScroll->_eOrientation = Orientation::e::Horizontal;
  ws->_pHScroll->_pBackImgs = Ui3Tex::create(screen, Gu::getPackage()->makeAssetPath("ui", "wings-scroll-h-3p.png"));
  ws->_pHScroll->_pThumbImgs = Ui3Tex::create(screen, Gu::getPackage()->makeAssetPath("ui", "wings-scroll-thumb-h-3p.png"));
  ...
  ws->_pVScroll->_pBackImgs = Ui3Tex::create(screen, Gu::getPackage()->makeAssetPath("ui", "wings-scroll-v-3p.png"));
  ws->_pVScroll->_pThumbImgs = Ui3Tex::create(screen, Gu::getPackage()->makeAssetPath("ui", "wings-scroll-thumb-v-3p.png"));
  ...
  *ws->_pTitleFont = *lbl;
  ...
  tbs->_pBackImgs = Ui3Tex::create(screen, Gu::getPackage()->makeAssetPath("ui", "wings-track-h-3p.png"));
  tbs->_pThumbImgs = Ui3Tex::create(screen, Gu::getPackage()->makeAssetPath("ui", "wings-track-thumb-h-3p.png"));
  ...
  fb->_pUp = Ui9Tex::create(screen, Gu::getPackage()->makeAssetPath("ui", "wings-button-9p-up.png"));
  fb->_pHv = Ui9Tex::create(screen, Gu::getPackage()->makeAssetPath("ui", "wings-button-9p-hv.png"));
  fb->_pDn = Ui9Tex::create(screen, Gu::getPackage()->makeAssetPath("ui", "wings-button-9p-dn.png"));
  ...
  *dd->_pArrowButtonSkin = *fb;
  ...
  cbs->_pCheckImg = UiTex::create(screen, Gu::getPackage()->makeAssetPath("ui", "wings-checkbox-check.png"));
  ...
  *_pGuiSkin->pToolbarSkin->_pWindowSkin = *ws;
  ...
  _pGuiSkin->pToolbarSkin->_pWindowSkin->_pBorderImgs = Ui9Tex::create(screen, Gu::getPackage()->makeAssetPath("ui", "wings-toolbar-9p.png"));
  ...
  *_pGuiSkin->pToolbarSkin->_pFlexButtonSkin = *fb;
  ...
  _pGuiSkin->pCursorSkin->_pTex = UiTex::create(screen, Gu::getPackage()->makeAssetPath("ui", "wings-cursor.png"));
  ...
  *_pGuiSkin->pAssetWindowSkin->_pFlexButtonSkin = *fb;
  ...
  _pGuiSkin->pTbMenu = UiTex::create(screen, Gu::getPackage()->makeAssetPath("ui", "menu-bt-img.png"));
  _pGuiSkin->pTbObjects = UiTex::create(screen, Gu::getPackage()->makeAssetPath("ui", "tree-bt-img.png"));
  _pGuiSkin->pTbSettings = UiTex::create(screen, Gu::getPackage()->makeAssetPath("ui", "gear-bt-img.png"));
  _pGuiSkin->pCoinImg = UiTex::create(screen, Gu::getPackage()->makeAssetPath("ui", "coin-bt-img.png"));
  _pGuiSkin->pTbGrid0 = UiTex::create(screen, Gu::getPackage()->makeAssetPath("ui", "grid0-bt-img.png"));
  _pGuiSkin->pTbGrid1 = UiTex::create(screen, Gu::getPackage()->makeAssetPath("ui", "grid1-bt-img.png"));
  _pGuiSkin->pTbGrid2 = UiTex::create(screen, Gu::getPackage()->makeAssetPath("ui", "grid2-bt-img.png"));
  _pGuiSkin->pTbTerrain = UiTex::create(screen, Gu::getPackage()->makeAssetPath("ui", "terrain-bt-img.png"));
  _pGuiSkin->pTbHouse = UiTex::create(screen, Gu::getPackage()->makeAssetPath("ui", "house-bt-img.png"));
}
void GameUi::createToolbar() {
  ...
  std::weak_ptr<BottleScript> r_w = _pScript;
  ...
  tbHouse->setClick([sk]() {
    ...
    //if (std::shared_ptr<UiWindow> win = winTer_wekak.lock()) {
    //    Gu::getCoreContext()->getSoundCache()->tryPlay(sk->pButtonClickSound);
    //    win->show();
    //}
    });
...
//  tb->width() = uDim(px, UiDimUnit::e::Pixel);
  ...
  _pScript->getScene()->getUiScreen()->addChild(tb);
...
std::shared_ptr<UiWindow> GameUi::createAssetWindow() {
  ...
  float dh = _pScript->getScene()->getUiScreen()->getDesignSize().getHeight();
...
std::shared_ptr<UiWindow> GameUi::createConfigWindow() {
  ...
  //makeSD("FOV", _pScript->getScene()->getActiveCamera()->getFOV(), 45.0f, 179.0f, 1.0f, [_pScript](std::shared_ptr<UiScrubGen> sb, float fScroll) {
  //  _pScript->getScene()->getActiveCamera()->setFOV(fScroll);
  //  });
  makeSD("Draw Dist", Gu::getRenderSettings()->drawDistance(), 2.0f, 60.0f, 1.0f, [](std::shared_ptr<UiScrubGen> sb, float fScroll) {
    Gu::getRenderSettings()->drawDistance() = fScroll;
    });

  makeHead("Render", 0);
  makeChk(Gu::getRenderSettings()->getDOF(), "DOF", [](bool b) { Gu::getRenderSettings()->getDOF() = b; });
  makeChk(Gu::getRenderSettings()->getSmoothShadows(), "Shadow Smoothing", [](bool b) { Gu::getRenderSettings()->getSmoothShadows() = b; });
  makeChk(Gu::getRenderSettings()->enableTransparency(), "Enable Transparency", [](bool b) {Gu::getRenderSettings()->enableTransparency() = b; });
  makeChk(Gu::getRenderSettings()->getBloom(), "Bloom", [](bool b) {Gu::getRenderSettings()->getBloom() = b; });
  makeChk(Gu::getRenderSettings()->getAmbientOcclusion(), "SSAO", [](bool b) {Gu::getRenderSettings()->getAmbientOcclusion() = b; });
  makeSD(" Samples", (float)Gu::getRenderSettings()->getAmbientOcclusionSamples(), 1, 100, 1, [](std::shared_ptr<UiScrubGen> sb, float fScroll) {Gu::getRenderSettings()->getAmbientOcclusionSamples() = fScroll; });

  //makeChk((Gu::getCoreContext()->getGui()->getTex()->oglGetFilter() == TexFilter::e::Linear), "Toggle UI Texture Filter", [](bool b) {
  //  if (Gu::getCoreContext()->getGui() && Gu::getCoreContext()->getGui()->getTex()) {
  //    if (b) {

  //      Gu::getCoreContext()->getGui()->getTex()->oglSetFilter(TexFilter::e::Linear);
  //    }
  //    else {
  //      Gu::getCoreContext()->getGui()->getTex()->oglSetFilter(TexFilter::e::Nearest);
  //    }
  //  }
  //  else { BRLogError("No GUI tex. ERR!"); }
  //  });
  ...
  makeHead("Debug", 0);
  makeHead("Boxes", 1);
  makeChk(Gu::getRenderSettings()->getDebug()->getShowModelBoundBox(), "Model Boundbox", [](bool b) { Gu::getRenderSettings()->getDebug()->getShowModelBoundBox() = b; });
  makeChk(Gu::getRenderSettings()->getDebug()->getShowBoneBoxes(), "Bone Boxes", [](bool b) { Gu::getRenderSettings()->getDebug()->getShowBoneBoxes() = b; });
  makeChk(Gu::getRenderSettings()->getDebug()->getShowMeshBoxes(), "Mesh Boxes", [](bool b) { Gu::getRenderSettings()->getDebug()->getShowMeshBoxes() = b; });
  makeChk(Gu::getRenderSettings()->getDebug()->getShowBoneBindBoxes(), "Bone Bind Boxes", [](bool b) { Gu::getRenderSettings()->getDebug()->getShowBoneBindBoxes() = b; });

  makeHead("Visuals", 1);
  makeChk(Gu::getRenderSettings()->getDebug()->getShowNormals(), "Normals", [](bool b) { Gu::getRenderSettings()->getDebug()->getShowNormals() = b; });
  makeChk(Gu::getRenderSettings()->getDebug()->getShowArmatures(), "Armatures", [](bool b) { Gu::getRenderSettings()->getDebug()->getShowArmatures() = b; });
  makeChk(Gu::getRenderSettings()->getDebug()->getShowShadowBox(), "Shadow Boxes", [](bool b) { Gu::getRenderSettings()->getDebug()->getShowShadowBox() = b; });

  makeHead("Gui", 1);
  makeChk(false, "Pick Gui", [](bool b) { Gu::getRenderSettings()->getDebug()->getPickGui() = b; });
  makeChk(false, "Gui Boxes & Disable Clip", [](bool b) { Gu::getRenderSettings()->getDebug()->getShowGuiBoxesAndDisableClipping() = b; });



  _pScript->getScene()->getUiScreen()->addChild(winConfig);
...
std::shared_ptr<UiWindow> GameUi::createMenuWindow() {
  ...
  _pScript->getScene()->getUiScreen()->addChild(win);
...
std::shared_ptr<UiWindow> GameUi::createTerrainWindow() {
  ...
  Gu::getCoreContext()->getGui()->addChild(win);
  return win;
  */
