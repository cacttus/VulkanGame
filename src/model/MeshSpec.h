...
public:
  ...
  std::shared_ptr<MeshSpec> createCopy();// Duplicates this spec data
  std::shared_ptr<MeshSpec> mergeWith(std::shared_ptr<MeshSpec> other, bool automaticallyRecalculateIndexOffsets = true);
  void computeBox();
