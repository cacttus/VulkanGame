...
public:
  ...
  BR2_FORCE_INLINE Box3x(const Tx& minx, const Tx& miny, const Tx& minz, const Tx& maxx, const Tx& maxy, const Tx& maxz);
  BR2_FORCE_INLINE Box3x(Vec3x<Tx>& vmin, Vec3x<Tx>& vmax);
  BR2_FORCE_INLINE Box3x();
  BR2_FORCE_INLINE ~Box3x();

  void construct(Box3x<Tx>& rhs);

  BR2_FORCE_INLINE Vec3x<Tx>& getMin();
  BR2_FORCE_INLINE Vec3x<Tx>& getMax();
  BR2_FORCE_INLINE const Vec3x<Tx>& getMin() const;
  BR2_FORCE_INLINE const Vec3x<Tx>& getMax() const;

  BR2_FORCE_INLINE STATIC void snapPointToGridCubeVertex(Vec3x<Tx>* pt, Box3f* cube, float gridCubeSize = 1.0f);
  BR2_FORCE_INLINE STATIC void snapPointToGridCube(Vec3x<Tx>* pt, Box3f* cube, float gridCubeSize = 1.0f);
  BR2_FORCE_INLINE STATIC void getCubeIntersectionVolume(Box3f* a, Box3f* b, Box3f* __out_ out);
  BR2_FORCE_INLINE STATIC void getPoints(const Vec3x<Tx>& vmin, const Vec3x<Tx>& vmax, Vec3x<Tx>* points);
  BR2_FORCE_INLINE STATIC void getPlanesAx(Vec3x<Tx>* points, Plane3f* planes);
  BR2_FORCE_INLINE STATIC void getPlanesOriented(Vec3x<Tx>* points, Plane3f* planes);

  BR2_FORCE_INLINE void copyFrom(const Box3f* other);
  BR2_FORCE_INLINE bool containsInclusive(const Vec3x<Tx>& v) const;
  BR2_FORCE_INLINE bool containsExclusive(const Vec3x<Tx>& v) const;
  BR2_FORCE_INLINE bool containsBottomLeftInclusive(const Vec3x<Tx>& v) const;
  BR2_FORCE_INLINE bool cubeIntersect_EasyOut_Inclusive(Box3f* cc);
  BR2_FORCE_INLINE bool cubeIntersect_EasyOut_Exclusive(Box3f* cc);
  BR2_FORCE_INLINE bool RayIntersect(const ProjectedRay* ray, RaycastHit* bh = NULL) const;
  BR2_FORCE_INLINE bool sphereIntersect(Sphere3f* s);
  BR2_FORCE_INLINE bool sphereIntersect(Vec3x<Tx>* center, float r);
  BR2_FORCE_INLINE void genResetLimits();
  BR2_FORCE_INLINE void genExpandByPoint(const Vec3x<Tx>& pt);
  BR2_FORCE_INLINE void genExpandByBox(Box3f* pc);
  BR2_FORCE_INLINE bool getHasVolume(float epsilon = FLT_MIN);
  BR2_FORCE_INLINE void getSatExtents(Vec3x<Tx>& normal, float& minf, float& maxf);
  BR2_FORCE_INLINE void getPoints(Vec3x<Tx>* __out_ points, int32_t arrayElementCount) const;
  BR2_FORCE_INLINE bool fullyContains(Box3f* cc);
  BR2_FORCE_INLINE bool RayIntersect_EasyOut(Ray_t* ray) const;
  BR2_FORCE_INLINE bool LineOrRayIntersectInclusive_EasyOut(const ProjectedRay* ray, RaycastHit* __opt_ __out_ bh = NULL) const;
  BR2_FORCE_INLINE bool LineOrRayIntersectInclusive_FullData(ProjectedRay* ray, RaycastHit* bh) const;
  BR2_FORCE_INLINE bool RayIntersect_Slow(ProjectedRay* ray, RaycastHit* bh);
  BR2_FORCE_INLINE const Vec3x<Tx>& bounds(int32_t in__) const;
  BR2_FORCE_INLINE Vec3x<Tx> center();
  BR2_FORCE_INLINE Vec3x<Tx> diagonal();
  BR2_FORCE_INLINE void closestPoint(const Vec3x<Tx>& point, vec3& __out_ closestPt) const;
  BR2_FORCE_INLINE float distance2(const Vec3x<Tx>& point) const;  // Accurate distance to a point.
  BR2_FORCE_INLINE float getVolumeArbitrary();
  BR2_FORCE_INLINE float getVolumePositiveOnly();
  //FORCE_INLINE float distance2(Box3x* cube);
  BR2_FORCE_INLINE bool validateBoundBox();
  BR2_FORCE_INLINE bool volumeIsNotTooBig();
  BR2_FORCE_INLINE bool validateInterval() const;
  BR2_FORCE_INLINE float getWidth() { return (_max.x - _min.x); }
  BR2_FORCE_INLINE float getHeight() { return (_max.y - _min.y); }
  BR2_FORCE_INLINE float getDepth() { return (_max.z - _min.z); }
  BR2_FORCE_INLINE float outerRadius(); // Computes a spherical radius that contains this box
  BR2_FORCE_INLINE float innerRadius(); // Computes a spherical radius that is contained within this box
  BR2_FORCE_INLINE string_t toString();
  BR2_FORCE_INLINE void operator=(const Tx& rhs);
  BR2_FORCE_INLINE bool operator!=(const Box3x<Tx>& rhs) const;
  BR2_FORCE_INLINE bool limitSizeForEachAxis(const vec3& vBasePos, const float& fSize);
};

template < class Tx >
BR2_FORCE_INLINE Box3x<Tx>::Box3x(const Tx& minx, const Tx& miny, const Tx& minz,
  const Tx& maxx, const Tx& maxy, const Tx& maxz) {
  _min = Vec3x<Tx>(minx, miny, minz);
  _max = Vec3x<Tx>(maxx, maxy, maxz);
}
template < class Tx >
BR2_FORCE_INLINE Box3x<Tx>::Box3x(Vec3x<Tx>& vmin, Vec3x<Tx>& vmax) {
  _min = vmin;
  _max = vmax;
}
template < class Tx >
BR2_FORCE_INLINE Box3x<Tx>::Box3x() {
}
template < class Tx >
BR2_FORCE_INLINE Box3x<Tx>::~Box3x() {
...
template < class Tx >
BR2_FORCE_INLINE Vec3x<Tx>& Box3x<Tx>::getMin() { return _min; }
template < class Tx >
BR2_FORCE_INLINE Vec3x<Tx>& Box3x<Tx>::getMax() { return _max; }
template < class Tx >
BR2_FORCE_INLINE const Vec3x<Tx>& Box3x<Tx>::getMin() const { return _min; }
template < class Tx >
BR2_FORCE_INLINE const Vec3x<Tx>& Box3x<Tx>::getMax() const { return _max; }

template < class Tx >
BR2_FORCE_INLINE void Box3x<Tx>::copyFrom(const Box3f* other) {
  _min = other->getMin();
  _max = other->getMax();
}
...
template < class Tx >
BR2_FORCE_INLINE bool Box3x<Tx>::containsInclusive(const Vec3x<Tx>& v) const {
  return (
...
template < class Tx >
BR2_FORCE_INLINE bool Box3x<Tx>::containsExclusive(const Vec3x<Tx>& v) const {
  return (
    (v.x > _min.x) && (v.x < _max.x) &&
    (v.y > _min.y) && (v.y < _max.y) &&
    (v.z > _min.z) && (v.z < _max.z)
...
template < class Tx >
BR2_FORCE_INLINE bool Box3x<Tx>::containsBottomLeftInclusive(const Vec3x<Tx>& v) const {
  return (
    (v.x >= _min.x) && (v.x < _max.x) &&
    (v.y >= _min.y) && (v.y < _max.y) &&
    (v.z >= _min.z) && (v.z < _max.z)
...
*/
template < class Tx >
BR2_FORCE_INLINE bool Box3x<Tx>::cubeIntersect_EasyOut_Inclusive(Box3f* cc) {
...
*/
template < class Tx >
BR2_FORCE_INLINE bool Box3x<Tx>::cubeIntersect_EasyOut_Exclusive(Box3f* cc) {
...
*/
template < class Tx >
BR2_FORCE_INLINE bool Box3x<Tx>::RayIntersect(const ProjectedRay* ray, RaycastHit* bh) const {
...
*/
template < class Tx >
BR2_FORCE_INLINE bool Box3x<Tx>::sphereIntersect(Vec3x<Tx>* center, float r) {
...
template < class Tx >
BR2_FORCE_INLINE void Box3x<Tx>::snapPointToGridCubeVertex(Vec3x<Tx>* pt, Box3f* cube, float gridCubeSize) {
  float dfx, dfy, dfz;
  float adx, ady, adz;
  float gcs, gcs_2;
...
// IN: gridCubeSzie - size of a cube in the grid space.
template < class Tx >
BR2_FORCE_INLINE void Box3x<Tx>::snapPointToGridCube(Vec3x<Tx>* pt, Box3f* cube, float gridCubeSize) {
...
template < class Tx >
BR2_FORCE_INLINE void Box3x<Tx>::genResetLimits() {
  _min = VEC3_MAX;
  _max = VEC3_MIN;
}
template < class Tx >
BR2_FORCE_INLINE void Box3x<Tx>::genExpandByPoint(const Vec3x<Tx>& pt) {
  _min = Vec3x<Tx>::minv(_min, pt);
  _max = Vec3x<Tx>::maxv(_max, pt);
}
template < class Tx >
BR2_FORCE_INLINE void Box3x<Tx>::genExpandByBox(Box3f* pc) {
  genExpandByPoint(pc->_min);
  genExpandByPoint(pc->_max);
}
template < class Tx >
BR2_FORCE_INLINE bool Box3x<Tx>::getHasVolume(float epsilon) {
...
template < class Tx >
BR2_FORCE_INLINE float Box3x<Tx>::getVolumePositiveOnly() {
...
template < class Tx >
BR2_FORCE_INLINE float Box3x<Tx>::getVolumeArbitrary() {
...
*/
template < class Tx >
BR2_FORCE_INLINE void Box3x<Tx>::getSatExtents(Vec3x<Tx>& normal, float& minf, float& maxf) {
...
*/
template < class Tx >
BR2_FORCE_INLINE void Box3x<Tx>::getCubeIntersectionVolume(Box3f* a, Box3f* b, Box3f* __out_ out) {
...
template < class Tx >
BR2_FORCE_INLINE void Box3x<Tx>::getPoints(/*out*/ Vec3x<Tx>* __out_ points, int32_t arrayElementCount) const {
  AssertOrThrow2(arrayElementCount == 8);
  Box3f::getPoints(_min, _max, points);
}

template < class Tx >
BR2_FORCE_INLINE void Box3x<Tx>::getPoints(const Vec3x<Tx>& vmin, const Vec3x<Tx>& vmax, Vec3x<Tx>* points) {
  //LHS coords
...
template < class Tx >
BR2_FORCE_INLINE void Box3x<Tx>::getPlanesAx(Vec3x<Tx>* points, Plane3f* planes) {
...
template < class Tx >
BR2_FORCE_INLINE void Box3x<Tx>::getPlanesOriented(Vec3x<Tx>* points, Plane3f* planes) {
  // - Outward facing normals
  // Index is the indexes from DMC.
  // refer to "side indexes.png"
...
template < class Tx >
BR2_FORCE_INLINE bool Box3x<Tx>::fullyContains(Box3f* cc) {
  return (containsExclusive(cc->_min) && containsExclusive(cc->_max));
}

template < class Tx >
BR2_FORCE_INLINE bool Box3x<Tx>::RayIntersect_EasyOut(Ray_t* ray) const {
  RaycastHit rh;
...
*/
template < class Tx >
BR2_FORCE_INLINE bool Box3x<Tx>::LineOrRayIntersectInclusive_EasyOut(const ProjectedRay* ray, RaycastHit* __opt_ __out_ bh) const {
...
*/
template < class Tx >
BR2_FORCE_INLINE bool Box3x<Tx>::LineOrRayIntersectInclusive_FullData(ProjectedRay* ray, RaycastHit* bh) const {
...
template < class Tx >
BR2_FORCE_INLINE bool Box3x<Tx>::RayIntersect_Slow(ProjectedRay* ray, RaycastHit* bh) {
  AssertOrThrow2(bh != NULL);
  AssertOrThrow2(ray != NULL);
...
template < class Tx >
BR2_FORCE_INLINE const Vec3x<Tx>& Box3x<Tx>::bounds(int32_t in__) const {
  if (in__ == 0) return _min;
  return _max;
}
template < class Tx >
BR2_FORCE_INLINE Vec3x<Tx> Box3x<Tx>::center() {
  return _min + (_max - _min) * 0.5f;
}
template < class Tx >
BR2_FORCE_INLINE Vec3x<Tx> Box3x<Tx>::diagonal() {
  return (_max - _min);
}
/**
*    @fn closestPoint
...
*/
template < class Tx >
BR2_FORCE_INLINE void Box3x<Tx>::closestPoint(const Vec3x<Tx>& point, vec3& __out_ closestPt) const {
...
*/
template < class Tx >
BR2_FORCE_INLINE float Box3x<Tx>::distance2(const Vec3x<Tx>& point) const {
  vec3 retPt;
...
template < class Tx >
BR2_FORCE_INLINE bool Box3x<Tx>::validateBoundBox() {
...
template < class Tx >
BR2_FORCE_INLINE bool Box3x<Tx>::volumeIsNotTooBig() {
...
template < class Tx >
BR2_FORCE_INLINE bool Box3x<Tx>::validateInterval() const {
  return (_max.x >= _min.x) && (_max.y >= _min.y) && (_max.z >= _min.z);
}
template < class Tx >
BR2_FORCE_INLINE void Box3x<Tx>::operator=(const Tx& rhs) {
  _min = rhs;
  _max = rhs;
}
template < class Tx >
BR2_FORCE_INLINE bool Box3x<Tx>::operator!=(const Box3x<Tx>& rhs) const {
  return (this->_min != rhs._min) || (this->_max != rhs._max);
}
template < class Tx >
BR2_FORCE_INLINE float Box3x<Tx>::outerRadius() {
  Vec3x<Tx> c = center();
...
template < class Tx >
BR2_FORCE_INLINE float Box3x<Tx>::innerRadius() {
  Vec3x<Tx> c = center();
  Vec3x<Tx> dMin = _min - c;
  Vec3x<Tx> dMax = _max - c;
...
template < class Tx >
BR2_FORCE_INLINE string_t Box3x<Tx>::toString() {
  return Stz "{"+ _min.toString()+ "},{"+ _max.toString()+ "}";
}
template < class Tx >
BR2_FORCE_INLINE bool Box3x<Tx>::limitSizeForEachAxis(const vec3& vBasePos, const float& fSize) {
  bool b = false;
