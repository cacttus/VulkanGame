...
public:
  ...
  static std::shared_ptr<BufferRenderTarget> createTarget(std::shared_ptr<GLContext> ctx, string_t strName, GLenum texFormat, GLenum internalFormat, GLenum dataType, int32_t w, int32_t h, RenderTargetType::e eTargetType, int32_t iIndex, bool bMsaaEnabled, int32_t nMsaaSamples);
  static std::shared_ptr<BufferRenderTarget> createDepthTarget(std::shared_ptr<GLContext> ctx, string_t strName, int32_t w, int32_t h, int iIndex, bool bMsaaEnabled, int32_t nMsaaSamples);
protected:
