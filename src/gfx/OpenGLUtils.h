...
// 
//   // Textures
//   static void createDepthTexture(std::shared_ptr<GLContext> ctx, const string_t& owner, GLuint* __out_ texId, int32_t w, int32_t h, bool bMsaaEnabled, int32_t nMsaaSamples, GLenum eRequestedDepth);
//   static GLenum getSupportedDepthSize(std::shared_ptr<GLContext> ctx);
