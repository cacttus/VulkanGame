...
public:
  ...
  void setDefaultColor(const vec4& v) { _vDefaultColor = v; }
  ...
  void vt1(const v_v3c4& v1);
  void vt1(const vec3& v, const vec4& c);
  void vt2(const v_v3c4& v1, const v_v3c4& v2);
...
public:
  ...
  void begin(GLenum type);
  void vt1(const v_v2c4& v1);
  void vt2(const vec2& v1, const vec2& v2, vec4* color = nullptr);
